      ...
      <div className="w-3/5 pt-50">
        ...
        <div className='flex flex-wrap w-full'>
          ...
          <div className='mt-20 w-full text-base'>
            ...
            <div className='mt-10'>
              &nbsp;처음 HTML과 CSS를 배울 때는 처음 접하는 분야이기도 하며, 무엇이든 ‘왜 그렇게 되는 거지?’ 라는 의문을 갖고 원리를 이해해야만 넘어가는 저의 성향 때문에 수업 내용을 이해하기가 쉽지 않았습니다.<br/>
              하지만 모르는 것에 대해 선생님들에게 적극적으로 질문하고 배운 내용을 복습하며 그 내용을 토대로 각 기능을 프로젝트 작업에 추가하다 보니 작성하는 대로 화면에 반영이 되는 결과물을 볼 수 있었습니다.<br/>
              시간이 지날수록 예전에 수업하던 내용이 차츰 이해가 되며, 처음 시작보다 점차 발전 하는 스스로의 모습을 보니 뿌듯함을 느끼고, 개발자라는 직업에 대해 더욱 큰 매력을 느꼈습니다. 첫 포트폴리오 작업에는 2~3개월 시간이 소요되었지만, 2차 프로젝트 작업은 2주, 3차 프로젝트 작업은 5일이라는 시간 내로 프로젝트를 완성할 수 있었습니다. 마지막까지 개인 포트폴리오 작업을 최선을 다해 임해 방송정보국제교육원을 수료하면서 작품상도 같이 받게 되었습니다. 더욱 더 열심히 할 수 있게 만드는 동기부여가 되는 상이였습니다.
            </div>
          </div>
        </div>
      </div>
