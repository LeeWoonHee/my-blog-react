  ...
  return (
    <div className="aboutSection w-full h-full blex">
      <div className="w-3/5 pt-50">
        ...
        {/* 회사 및 학원 이력  */}
        <div className='flex flex-wrap w-full'>
          <div className='mt-50 pb-10 w-full border-b-1 border-gray font-bold text-lg'>회사 및 학원 이력 <span className='font-normal text-xs text-gray'>(개발에 관련된 이력만 작성하였습니다.)</span></div>
