      ...
      <div className="w-3/5 pt-50">
        ...
        <div className='flex flex-wrap w-full'>
          ...
          <div className='mt-20 w-full text-base'>
            ...
            <div className='mt-10'>
              &nbsp;처음 HTML과 CSS를 배울 때는 처음 접하는 분야이기도 하며, 무엇이든 ‘왜 그렇게 되는 거지?’ 라는 의문을 갖고 원리를 이해해야만 넘어가는 저의 성향 때문에 수업 내용을 이해하기가 쉽지 않았습니다. 하지만 모르는 것에 대해 선생님들에게 적극적으로 질문하고 배운 내용을 복습하며 그 내용을 토대로 각 기능을 프로젝트 작업에 추가하다 보니 작성하는 대로 화면에 반영이 되는 결과물을 볼 수 있었습니다.
