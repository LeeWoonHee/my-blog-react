        ...
        <div className='flex flex-wrap w-full'>
          ...
          <div className='mt-20 w-full text-base'>
            ...
            <div className='mt-10'>
              ...
              Vue를 배우고 Three.js,Gsap 등을 배우면서 사람들의 이목을 끌 수 있는 개발을 하는 방법을 배웠습니다.<br/>
              프로젝트들을 거쳐가면서 혼자서 해결하는 방법들을 스스로 깨우치고, 회사마다 코드를 작성하는 방법과 폴더링하는 방법은 다르겠지만,
              타인이 봤을 때 눈에 쉽게 들어오는 코드를 작성하기 위해 신경을 많이 썼습니다.
                else.red 사이트를 제작을 하면서 vue라는 언어에 대해 더 깊게 알아가는 기회가 되었고, 지식을 쌓고 사용하는 것이 아닌 사용을 
            </div>
          </div>
        </div>
      </div>
