  ...
  useEffect(() => {
    if (next && timeline.isActive() === false) {
      timeline
        ...
        .to('.background-image-active .backgroundImgBox', {
          borderRadius: 0,
          duration: 1
        }, '-=1')
        .to('.background-image-active .virtual-bg', {
          borderRadius: 0,
          duration: 1
        }, '-=1')
        .fromTo('.background-image-active  .swiper-text', {
      ...
      timeline
        ...
        .to('.background-image-active+.background-image .virtual-bg', {
          borderRadius: '25px',
          duration: 1
        }, '-=1')
        .to('.background-image-active+.background-image .backgroundImgBox', {
          borderRadius: '25px',
          duration: 1
        }, '-=1')
